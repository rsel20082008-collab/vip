...
# معرف الآدمن (ضع الـ ID الخاص بك هنا)
ADMIN_IDS = [8206337665] 

SYSTEM_NAME = "SAJIN"
RIGHTS_HEADER = "👑 **SAJIN SYSTEM SYSTEM v4.0** 👑"
    ...
    try:
        ...
        if response.status_code == 201 and data.get("status") == "SUCCESS":
            ...
            result_text = (
                ...
                f"💡 *اضغط على المفتاح أعلاه لنسخه مباشرة.*"
            )
