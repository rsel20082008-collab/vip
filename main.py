...
# استخدام parse_mode="HTML" تفادياً لمشاكل التنسيق القاتلة
...
def send_welcome(message):
    ...
    welcome_text = (
        ...
        f"----------------------------------------\n"
        f"👤 <b>المستخدم:</b> <code>{user.first_name}</code>\n"
...
def handle_callback_query(call):
    ...
    # ─── 5. طريقة كتابة الكود وإضافته للسورس ───
        ...
        cpp_code = (
            ...
            f"#include &lt;iostream&gt;\n"
            f"#include &lt;cpr/cpr.h&gt;\n\n"
            f"std::string API_URL = \"https://sajin13-production.up.railway.app/connect\";\n\n"
        ...
        py_code = (
            ...
            f"import requests\n\n"
            f"SERVER_URL = \"https://sajin13-production.up.railway.app/connect\"\n\n"
        ...
        curl_code = (
            ...
            f"curl -X POST https://sajin13-production.up.railway.app/connect \\\n"
...
def generate_license_key(chat_id, days, creator_id):
    ...
    try:
        ...
        bot.send_message(chat_id, f"⚠️ <b>خطأ أثناء الاتصال بالسيرفر:</b> <code>{str(e)}</code>", reply_markup=back_keyboard())
